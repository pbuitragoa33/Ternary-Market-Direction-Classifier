# Module for loading the unified data for 5 day prediction to be processed

# This script aims to:

#   - Load the 5d_pred_data_unified.csv located in S3 bucket in silver folder
...
S3_KEY_SILVER = "silver/5d_pred_data_unified.csv"
