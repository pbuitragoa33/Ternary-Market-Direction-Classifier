# 10. Target Variable Treatment to make 5-day ahead predictions
...
# Threshold for discretixation (2% change returns)
...
def discretize_target_variable(df, threshold = THRESHOLD):
    ...
    # Drop the null values created by shift
...
def upload_target_s3(df, 
                      ...
                      access_key_id = S3_ACCESS_KEY_ID, 
                      secret_access_key = S3_SECRET_ACCESS_KEY, 
                      s3_key = "silver/5d_pred_btc_target_column.csv"):
...
if __name__ == "__main__":
    ...
    print(f"Data uploaded to S3 bucket {S3_BUCKET_NAME} with key: silver/5d_pred_btc_target_column.csv")