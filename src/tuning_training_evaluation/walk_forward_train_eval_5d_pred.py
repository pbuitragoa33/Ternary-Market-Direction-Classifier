# Walk-forward training and evaluation Weights & Biases for 5 day prediction
...
DASHBOARD_DIR = os.path.join(WALKFORWARD_PATH, "fold_dashboards_5d")
...
GOLD_FILES = {
    "X_train": "gold/X_train_5d.csv", "y_train": "gold/y_train_5d.csv",
    "X_validation": "gold/X_validation_5d.csv", "y_validation": "gold/y_validation_5d.csv",
    "X_test": "gold/X_test_5d.csv", "y_test": "gold/y_test_5d.csv",
}
 
# Weights & Biases
 
WANDB_PROJECT = os.getenv("WANDB_PROJECT_5D", "TMDC_walkforward_5d")
...
if __name__ == "__main__":
    ...
    print("Walk-forward validation for 5-day predictions...")
    ...
    for model_name in MODELS_TO_RUN:
        ...
        folds_df.to_csv(os.path.join(WALKFORWARD_PATH, f"walkforward_5d_{model_name}.csv"), index = False)
        ...
        for fid in sorted(to_render):
            ...
            if fid in artifacts:
                ...
                path = os.path.join(DASHBOARD_DIR, f"{model_name}_fold{fid}_5d_pred.png")
    ...
    summary_path = os.path.join(WALKFORWARD_PATH, "walkforward_5d_summary.json")
    ...
    if f1_distributions:
        ...
        plot_path = os.path.join(WALKFORWARD_PATH, "walkforward_5d_f1_boxplot.png")
