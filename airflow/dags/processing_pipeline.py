...
class OneHotEncoding(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y = None):
        ...
        self.dummy_cols = self.encoder.get_feature_names_out(self.cols)
...
class RobustScaling(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y = None):
        ...
        self.continuous_cols = self.select_continuous_columns(X)
...
def execute_pipeline(key_entry = S3_KEY_SILVER,
    ...
    X_train = pipeline_ML.fit_transform(X_train)
    ...
    artifacts = {
        ...
        "continuous_columns_scaled": pipeline_ML.named_steps["robust_scaling"].continuous_cols
    }
